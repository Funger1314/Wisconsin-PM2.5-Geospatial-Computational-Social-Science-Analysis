...
from .mapping import plot_choropleth, plot_lisa_cluster_map, plot_population_scatter, plot_ranked_bar
from .notebooks import build_legacy_notebook, build_portfolio_notebook, execute_notebook
from .paths import FIGURES_DIR, INTERIM_DIR, LOGS_DIR, NOTEBOOKS_DIR, OUTPUTS_DIR, PM25_FIELD, PROCESSED_DIR, PROJECT_ROOT, RAW_DIR, REPORTS_DIR, SLIDES_DIR, TABLES_DIR
...
def _write_markdown_summary(summary: dict[str, object]) -> None:
...
def _build_writing_sample(context: AnalysisContext) -> None:
    ...
    figure_paths = [
        ...
        FIGURES_DIR / "pm25_2024_ranked_bar.png",
    ]
...
def _build_slides(context: AnalysisContext) -> None:
    ...
    slide_content = [
        ...
        {"title": "Sensitivity, Limitations, and Conclusion", "bullets": ["KNN weights remove zero-neighbor counties.", "Sparse coverage limits statewide inference.", "The most defensible conclusion is descriptive rather than causal or regulatory."], "figure": "knn_lisa", "footer": footer},
    ...
    figure_map = {
        ...
        "knn_lisa": FIGURES_DIR / "lisa_cluster_map_knn4.png",
    }
